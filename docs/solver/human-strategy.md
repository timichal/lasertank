...
| **Work backwards from the ending position** (hard pt 2 §7, quoting Sahan) | **already named**: FESS's packing order, [next-actions item 23](next-actions.md#23-5th--a-fess-shaped-rung-for-the-sokobanferry-half-of-the-corpus). The series is independent confirmation that the backward half is the one a Sokoban wants |
