...
| Godot 4.7.2 **.NET/Mono** build | `winget install GodotEngine.GodotEngine.Mono` | Phase 5 — the playable game, its editor, and the gates that want a window.  Skip it if you only care about the engine and the solver |
