...
Everything under `data/` came from laser-tank.com. Recorded here so it can be refreshed or
re-verified without guesswork.
...
recorded human solutions available. The `.ghs` targets stand in for the rest.
