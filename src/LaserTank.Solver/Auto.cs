...
namespace LaserTank.Solver
{
    internal static class Auto
    {
        ...
        internal static int Run(Program.Args a)
        {
            ...
            // ./solutions in the repo, deliberately, and not under build/.
            //
            ...
            // them.  The scratch directory the verifier stages through stays
            // under build/, because that part really is disposable.
            string outRoot = a.OutGiven ? a.Out : Path.Combine(root, "solutions");
